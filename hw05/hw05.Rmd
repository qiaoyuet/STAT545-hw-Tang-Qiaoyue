...
Using Multiplot function to juxtapose two plots
```{r, include=FALSE}
...
ggsave("lifeExp_gdp.png", plot = p1, width = 5, height = 5, dpi = 300) # raster format
```
...
![The plot saved above can be embedded in the report (in vector format)](/lifeExp_gdp.pdf)